...
public class ZadatakBr5RazdjeliString {
	...
	/**
	 * Funkciju  koja prima 2 parametra, varijablu tipa string i varijablu tipa char.
	 * @param recenica =  string koji pretvaramo u niz rijeci
	 * @param razmak = je prazan prostor izmedju rijeci
	 * @return =  vraca niz stringova koji se sastoje od dijelova koje dobijemo kad poslani string podijelimo
	 */
	public static String[] razdijeli ( String recenica, char razmak ){
		...
		int counter=0;
		int x = recenica.indexOf(razmak); // broj elemnata u stringu na kojem se nalazi razmak.
		while (x>=0){
			counter++;
		...
		temp=new String[counter+1]; // u posljednjem krugu vracanja u while petlju x=-1 jer nema vise razmaka u recenici
